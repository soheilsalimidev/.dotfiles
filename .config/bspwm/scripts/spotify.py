...
# Make sure that the font at index TEXT_FONT_INDEX is monospaced
...
# ;format-prefix = ""
# format = <label>
# exec = ~/dotfiles/polybar/scripts/polybar-now-playing.py
...
TEXT_FONT_INDEX = 0  # monospace!
ICON_FONT_INDEX = 1  # Use Font Awesome! Using Nerd Fonts can cause issues

TEXT_UPDATE_TIMEOUT = 0.5  # sec
STATE_UPDATE_BLOCKING_TIME = 0.5  # sec
PERIODIC_STATE_UPDATE_TIMEOUT = 5  # sec

NUMBER_CHARACTERS = 45
