{ host, ... }:
let inherit (import ../../../hosts/${host}/variables.nix) extraMonitorSettings;
in {
  wayland.windowManager.hyprland = {
    settings = {
      windowrulev2 = [
        ...
        "tag +projects, class:^(VSCode|code-url-handler|code)$"
        "tag +im, class:^([Dd]iscord|[Ww]ebCord|[Vv]esktop|spotify)$"
        ...
        "opacity 0.85 0.90, tag:browser*"
        "opacity 0.9 0.8, tag:projects*"
        "opacity 0.75 0.82, tag:im*"
